...
function baseCurso(overrides: Partial<Record<string, unknown>> = {}) {
  return {
    ...
    requisitos: [],
    precio: 49.9,
    instructor: { nombre: 'Ana Ruilova', email: 'ana@blogapp.dev' },
...
it('should list, create, edit and delete a course end to end', async () => {
  ...
  await user.type(screen.getByLabelText('Instructor'), 'Ruilova')
  await user.type(screen.getByLabelText('Email del instructor'), 'ruilova@blogapp.dev')
